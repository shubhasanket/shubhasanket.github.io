...
<div class="caption">
    Group project report at ENS Paris-Saclay. Joint work with Richard Cheam, Alexandre Duplessis, and Tudy Herriou.
</div>
...
Taken together, the project argues that at the 2–4B parameter scale CoT traces for MT are either ignored or harmful, that this reflects a *routing* problem rather than a capability gap, and that the right design principle is to preserve direct translation (System 1) for cases the model already handles well, applying minimal targeted reasoning only when verifiable post-checks make it worthwhile.
